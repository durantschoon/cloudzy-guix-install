...
**For systems with persistent ISO artifact issues:** Use `lib/recover-filesystem-invariants.sh` for complete recovery.
...
# Download the script
cd /root
wget https://raw.githubusercontent.com/durantschoon/cloudzy-guix-install/main/lib/recover-filesystem-invariants.sh
...
sudo ./recover-filesystem-invariants.sh
```
...
| Feature | `fix-iso-artifacts.sh` | `recover-filesystem-invariants.sh` |
|---------|------------------------|-------------------------------------|
...
**Recommendation:** Start with `fix-iso-artifacts.sh` for quick fixes. If issues persist, use `recover-filesystem-invariants.sh` for complete recovery.
...
**Note:** For automated recovery, use the `lib/recover-filesystem-invariants.sh` script (see below).
...
Use `lib/recover-filesystem-invariants.sh` script for automated recovery (see Recovery Scripts section below).
