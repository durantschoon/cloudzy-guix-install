...
EOF
            ...
            warn "   1. Check GDM keyboard layout (keyboard icon at login screen)"
            warn "   2. Switch to text console (Ctrl+Alt+F3)"
            warn "   3. Log in there (uses layout from config.scm)"
            warn "   4. Reset password: passwd yourusername"
            warn "      (Type password as it should work in GDM - may need translation)"
