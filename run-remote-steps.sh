...
declare -A SHA256=(
  ...
  ["cloudzy/install/04-system-init-clean.sh"]="986c8c59ced113ed48dee197cc414efad932a68113a2a56ae42acdde123438f9"
)
...
# NOTE: Minimal install only (scripts 01-04), then boot and customize
SCRIPT_BASES=(
